...
class ProteinClassifier(nn.Module):
    def __init__(self, pretrained_model_name, dropout=0.2):
        ...
        self.loss_fn = nn.BCEWithLogitsLoss(pos_weight=tensor([10.0]))
...
class CustomTrainer(Trainer):
    def compute_loss(self, model, inputs, return_outputs=False, **kwargs):
        ...
        loss_fn = nn.BCEWithLogitsLoss(pos_weight=tensor([10.0])).to(logits.device)
